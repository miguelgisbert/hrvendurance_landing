    ...
    <ThemeProvider theme={currentTheme}>
        <Grid container height="100vh" sx={{ backgroundColor: theme => theme.palette.background.main }}>
          ...
          <Grid container height="100vh" alignItems="center" justifyContent="center" padding="30px" spacing="30px">
            <Grid container item xs={12} md={7} alignItems="center" justifyContent="center">

            </Grid>
            <Grid container item xs={12} md={5} alignItems="center" justifyContent="center" sx={{ color: theme => theme.palette.primary.main, height:"100%" }}>
              <Grid item maxWidth="300px">
                <Typography>Mide Entrena Mejora</Typography>
                <Typography>Mide tu estado y define tu rutina a diario según tu VFC. En vez de usar rutinas predefinidas respeta tus ciclos fisiológicos y mejora tu rendimiento con esta nueva metodología validada en numerosos ensayos científicos.</Typography>
              </Grid>              
            </Grid>
          </Grid>
